      ...
      <div className="container relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-lg text-muted-foreground max-w-xl mx-auto mb-10 opacity-0 animate-fade-in" style={{ animationDelay: "0.4s" }}>
            Passionate about transforming raw, messy data into actionable insights. 
            I love building data pipelines and creating visualizations that enable informed decision-making.
          </p>
